...
function renderActionButton(link: ActionLink, color: string) {
  return `
    <a
...
function renderEmailLayout(input: {
  ...
  const codeBlock =
    input.codeLabel && input.codeValue
      ? `
...
export function buildSignupVerificationEmail(input: {
  ...
  const html = renderEmailLayout({
    preheader:
      "Use this OTP or one-click confirmation link to activate your Talvo account.",
    title: "Confirm your account",
    greeting: `Hi ${input.userName},`,
    intro:
      "Welcome to Talvo. Confirm your email address so your recruiter workspace is fully active.",
    details:
      "Use the one-time code below or open the confirmation link. For security, the verification expires in 10 minutes.",
    ...
    footerNote:
      "If you did not create this account, no action is needed and the verification code will expire automatically.",
  });
...
export function buildPasswordRecoveryEmail(input: {
  ...
  const html = renderEmailLayout({
    preheader:
      "Use this OTP or quick verification link to recover your Talvo account.",
    title: "Password recovery",
    greeting: `Hi ${input.userName},`,
    intro:
      "We received a request to reset your Talvo password. Complete verification to continue.",
    details:
      "Use the one-time code below in the reset screen, or use the quick verification link. The code expires in 10 minutes.",
    ...
    footerNote:
      "If you did not request this reset, your current password remains unchanged. For help, contact your administrator.",
  });
...
export function buildShortlistedApplicantEmail(input: {
  ...
  const html = renderEmailLayout({
    ...
    details:
      "Our recruiting team is preparing the next steps and will share interview scheduling details soon.",
    primaryAction: {
      label: "Contact recruiting team",
      href: contactUrl,
    },
    footerNote:
      "Thank you for your interest in Talvo. We appreciate the time you invested in your application.",
...
export function buildRejectedApplicantEmail(input: {
  ...
  const html = renderEmailLayout({
    ...
    details:
      "After careful review, we will not proceed with your application for this position. We truly appreciate your interest and time.",
    primaryAction: {
      label: "Explore future opportunities",
      href: jobsUrl,
    },
    footerNote:
      "We are grateful for your interest in Talvo and encourage you to apply for future roles that match your experience.",
